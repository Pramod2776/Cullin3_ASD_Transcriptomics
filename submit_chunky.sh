...
#chunky run PEC_DAC_RNAseq_new_index.py \
#    --reads  /home/jic307/jiayechen/3m/3m_16pAC11_b_R1.fastq.gz:/home/jic307/jiayechen/3m/3m_16pAC11_b_R2.fastq.gz \
#    --output 16p_human_new_index/3m \
#    --forward-adapter XXX --reverse-adapter XXX
